...
public class Modelbgm_boots<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("bgm", "modelbgm_boots"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LBoot = partdefinition.addOrReplaceChild("LBoot",
				CubeListBuilder.create().texOffs(0, 73).addBox(-3.0F, 8.0F, -3.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 64)
		...
		PartDefinition RBoot = partdefinition.addOrReplaceChild("RBoot",
				CubeListBuilder.create().texOffs(0, 73).addBox(-2.0F, 8.0F, -3.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 64)
