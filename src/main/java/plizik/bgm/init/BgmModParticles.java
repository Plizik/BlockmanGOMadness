...
import plizik.bgm.client.particle.ExplosionParticle;
...
public class BgmModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType EXPLOSION = register(new SimpleParticleType(false).setRegistryName("explosion"),
			ExplosionParticle::provider);
