...
public class MobspawnerBlock extends Block {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Doesn't spawn anything like BG spawner"));
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(BgmModBlocks.MOBSPAWNER.get(), renderType -> renderType == RenderType.cutout());
	}
