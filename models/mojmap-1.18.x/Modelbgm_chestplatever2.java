...
public class Modelbgm_chestplatever2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bgm_chestplatever2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(66, 29)
						.addBox(-2.0F, 5.0F, -5.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(118, 55)
		...
		PartDefinition cube_r11 = RightArm
				.addOrReplaceChild("cube_r11",
						CubeListBuilder.create().texOffs(0, 126).addBox(-13.0F, -9.0F, 1.0F, 2.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(5.0F, 22.0F, 0.0F, 0.0F, 0.0F, 0.5236F));

		PartDefinition cube_r12 = RightArm.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(114, 72).addBox(11.5F, -5.3F, -3.0F, 1.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5F, 18.3F, 0.0F, 0.0F, 0.0F, -0.4974F));

		PartDefinition cube_r13 = RightArm
				.addOrReplaceChild("cube_r13",
						CubeListBuilder.create().texOffs(0, 126).addBox(-11.0F, -11.0F, -1.0F, 2.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
